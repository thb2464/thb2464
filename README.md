...
|---------|------|-----------|
| [Tour Guide Web Travel](https://github.com/thb2464/TourGuideWeb-TVB) | Full-Stack + AI | React, Strapi, Google Gemini, ChromaDB, VNPay |
| [Fast Food Delivery](https://github.com/thb2464/Fast-Food-Delivery) | Full-Stack App | React, React Native, Node.js, PostgreSQL, WebSocket |
| [Fabric Agency Database](https://github.com/thb2464/Fabric-Agency-Database) | Desktop App | C# .NET, Windows Forms, SQL Server |
...
*Currently seeking entry-level developer opportunities to apply full-stack & backend skills.*
<br>
